...
<section class="hero wrap" aria-labelledby="hero-title">
  ...
  <figure class="portrait-block">
    <div class="portrait-frame photo-gallery" role="region" aria-roledescription="carousel" aria-label="Photo album">
      <div class="photo-track" tabindex="0" aria-label="Photos — swipe or use the arrow keys">
      ...
      <div class="photo-controls">
        ...
        <div class="photo-dots" aria-label="Choose a photo">
          <button type="button" aria-label="Show photo 1" aria-current="true"></button>
          <button type="button" aria-label="Show photo 2" aria-current="false"></button>
...
<section class="research-section" id="research" aria-labelledby="research-title">
  <div class="wrap">
    ...
    <div class="research-grid">
      <article class="research-item"><div class="research-number">01 <span>CORE FOCUS</span></div><div class="research-diagram research-diagram--tracking" aria-hidden="true"><svg viewBox="0 0 280 76"><path class="diagram-path" d="M5 54 C55 54 65 17 112 22 S191 63 275 21"/><path class="diagram-path muted" d="M5 22 C60 22 60 54 112 50 S190 10 275 54"/><rect class="diagram-box" x="19" y="36" width="28" height="30"/><rect class="diagram-box" x="109" y="9" width="28" height="30"/><rect class="diagram-box" x="233" y="19" width="28" height="30"/><path class="diagram-occlusion" d="M164 3 V72 M169 3 V72 M174 3 V72 M179 3 V72 M184 3 V72"/><path class="diagram-flow" d="M5 54 C55 54 65 17 112 22 S191 63 275 21"/><path class="diagram-flow flow-secondary" d="M5 22 C60 22 60 54 112 50 S190 10 275 54"/></svg></div><h3>Identity through ambiguity</h3><p>Multi-object tracking that preserves identity through occlusion, interactions, and disappearance–reappearance.</p><div class="research-tags">Object association <span>·</span> Bounded local search</div></article>
      <article class="research-item"><div class="research-number">02 <span>ONGOING EXPLORATION</span></div><div class="research-diagram research-diagram--memory" aria-hidden="true"><svg viewBox="0 0 280 76"><path class="diagram-path muted" d="M22 38 H258 M70 14 V62 M140 14 V62 M210 14 V62"/><rect class="diagram-box" x="10" y="24" width="28" height="28"/><rect class="diagram-box" x="126" y="24" width="28" height="28"/><rect class="diagram-box" x="242" y="24" width="28" height="28"/><path class="diagram-path" d="M24 24 Q82 -12 140 24 M140 52 Q198 88 256 52"/><circle class="diagram-point" cx="140" cy="38" r="4"/><path class="diagram-flow" d="M24 24 Q82 -12 140 24"/><path class="diagram-flow flow-delayed" d="M140 52 Q198 88 256 52"/><circle class="diagram-pulse" cx="140" cy="38" r="12"/></svg></div><h3>Perception with memory</h3><p>Persistent visual representations and query-driven evidence retrieval for efficient multimodal scene reasoning.</p><div class="research-tags">Multimodal memory <span>·</span> 3D understanding</div></article>
      <article class="research-item"><div class="research-number">03 <span>FOUNDATIONS & APPLICATIONS</span></div><div class="research-diagram research-diagram--fusion" aria-hidden="true"><svg viewBox="0 0 280 76"><path class="diagram-path muted" d="M22 12 L140 38 L258 12 M22 64 L140 38 L258 64"/><path class="diagram-path" d="M22 38 H258"/><circle class="diagram-ring" cx="140" cy="38" r="22"/><circle class="diagram-point" cx="22" cy="12" r="4"/><circle class="diagram-point" cx="22" cy="38" r="4"/><circle class="diagram-point" cx="22" cy="64" r="4"/><circle class="diagram-point" cx="140" cy="38" r="5"/><path class="diagram-box" d="M249 3 H267 V21 H249 Z M249 55 H267 V73 H249 Z"/><path class="diagram-flow" d="M22 12 L140 38 L258 12"/><path class="diagram-flow flow-secondary" d="M22 38 H258"/><path class="diagram-flow flow-delayed" d="M22 64 L140 38 L258 64"/><circle class="diagram-pulse" cx="140" cy="38" r="17"/></svg></div><h3>Connecting multiple sources</h3><p>Combining remote sensing, visual observations, and AIS data for maritime geolocation and situational awareness.</p><div class="research-tags">Remote sensing <span>·</span> Visual–AIS fusion</div></article>
    </div>
